...
(function() {
  var content_css, css, default_confing, dir, elem_css, heightOf, log, page_css, paginate, sel, selAll, tpl, trans, transition, widthOf, wrapper_css, _i, _len, _ref;
  ...
  this.Gridy = (function() {
    ...
    function Gridy(component_sel, options) {
      var c, controls, key, tpl_str, val, _j, _len1,
        _this = this;
      if (options == null) {
        options = {};
      }
    ...
    Gridy.prototype.insert = function(data) {
      var c, col_width, cols, el_val, first_elem, first_page, key, page_size, paged, r, row_height, rows, val, _j, _k, _l, _len1, _len2, _len3, _len4, _m, _ref1, _ref2, _ref3, _ref4;
      if (data.length) {
        page_size = this.options.cols * this.options.rows;
        paged = '';
        _ref1 = paginate(data, page_size);
